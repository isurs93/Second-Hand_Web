...
<form enctype="multipart/form-data" method="post" action="UpdateProductInfo">
...
<br>
	<table style="margin-left: auto; margin-right: auto" >
		<tr height="30">
			<td>사진</td>
			<td><img src = "http://localhost:8080/test/${detail_productInfo.image_string}" width="300" height="300" margin-left="10"/></td>
			<td></td>
		</tr>
		...
		<tr>
			<td></td>
			<td><input type="hidden" name="board_seqno" value = "${detail_productInfo.board_seqno}" readonly="readonly"></td>
			
			<!-- <td><a href="id_check.do"><input type="button" value="중복확인"></a></td> -->
		</tr>
		<tr height="30">
			<td >제목</td>
			<td><input type="text" name="board_title" value = "${detail_productInfo.board_title}" style="width:300px;height:25px;font-size:13px;"></td>
			<!-- <td><a href="id_check.do"><input type="button" value="중복확인"></a></td> -->
		</tr>
		
		<tr height="30">
			<td>가격</td>
			<td><input type="text" name="board_price" value = "${detail_productInfo.board_price}"  style="width:150px;height:25px;font-size:13px;"></td>
		</tr>
		<tr height="30">
			<td>희망 지역</td>
		...
		<tr height="30">
			<td>상품내용</td>
			<td><textarea id="inputbox" name="board_content" cols="200" rows="15" style="resize: none;">
			${detail_productInfo.board_Content}			
			</textarea></td>
		...
		<tr height="30">
			<td>상태</td>
			<td><input type="text" name="board_isDone" value = "${detail_productInfo.board_isDone}"  style="width:150px;height:25px;font-size:13px;"></td>
		</tr>

		<tr>
			<td></td>
			<td><input formaction="MyProductList" type="submit" value="뒤로가기" style="border:none; width:200px;height:50px; color: white; background-color: black;">
			<input formaction="UpdateProductInfo?board_seq=${detail_productInfo.board_seqno}" type="submit" value="수정하기" style="border:none; width:200px;height:50px; color: white; background-color: black;">
			<input formaction="DeleteMyProduct?board_seq=${detail_productInfo.board_seqno}" type="submit" value="삭제하기" style="border:none; width:200px;height:50px; color: white; background-color: black;">
			</td>
		</tr>	
