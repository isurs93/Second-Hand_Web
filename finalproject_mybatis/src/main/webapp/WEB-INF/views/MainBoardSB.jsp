...
<div id="list">
   <table>
      ...
      <%if(count < 5){   count++;%>
        <td style="font-size: 20px"><a href="DetailProductList?board_seq=${dto.board_seqno}"><img src = "http://localhost:8080/test/${dto.image_string}" width="300" height="300" margin-left="10"/></a><br> 
