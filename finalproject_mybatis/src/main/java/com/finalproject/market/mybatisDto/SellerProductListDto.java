...
public class SellerProductListDto {
	...
	public SellerProductListDto() {
		// TODO Auto-generated constructor stub
	}

	public SellerProductListDto(String board_Content, String image_string, int board_seqno, int board_hit,
			String board_title, String board_price, String user_id, int board_useqno, String deal_location, String board_isDone) {
		super();
